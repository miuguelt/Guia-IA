...
window.GuiaModules['module-6'] = window.GuiaModules['module-7'] = (function() {
  ...
  window.checkM6 = function(el, ans) {
    ...
    if (ans === item.ans) { 
      ...
      window.showToast('+20 XP ¡Correcto!', 'success'); 
    } else { 
      el.classList.add('wrong'); 
      const opts = document.querySelectorAll('.m6-quiz-opt');
      const correctIdx = item.opts.indexOf(item.ans);
      if (opts[correctIdx]) opts[correctIdx].classList.add('correct');
    }
    const exp = document.getElementById('m6-exp');
    if (exp) {
      exp.style.display = 'block';
      exp.innerHTML = '💡 ' + item.exp + '<br><br><button class="gl-btn small" style="margin-top:8px;" onclick="m6Next()">Siguiente →</button>';
    }
  };
  ...
  window.m7GeneratePrompt = function() {
    ...
    if (output) {
      output.innerHTML = '<b style="color:#2563eb">✅ Prompt para Gamma / ChatGPT / Claude:</b><br><br>' + p;
    }
  ...
  window.pickM7 = function(pick) {
    ...
    if (pick === c.correct) { 
      ...
      window.showToast('+40 XP ¡Correcto!', 'success'); 
    }
    const exp = document.getElementById('m7-exp');
    if (exp) {
      exp.style.display = 'block';
      exp.innerHTML = '💡 ' + c.exp + '<br><br><button class="gl-btn small" style="margin-top:8px;" onclick="m7Next()">Siguiente →</button>';
    }
  };
    ...
    <div class="m6-prompt-studio">
      ...
      <div style="margin-bottom:18px;">
        ...
        <div style="margin-top:10px;">
          <span class="m6-style-pill active" data-style="fotorrealista, iluminación de estudio, colores institucionales suaves, 8K" onclick="m6TogglePill(this)">📸 Fotorrealista</span>
          <span class="m6-style-pill" data-style="ilustración plana minimalista, paleta de colores gubernamental, estilo corporativo limpio" onclick="m6TogglePill(this)">🎯 Corporativo</span>
          <span class="m6-style-pill" data-style="infografía moderna, iconos flat, tipografía sans-serif, fondo blanco, colores primarios" onclick="m6TogglePill(this)">📊 Infografía</span>
          <span class="m6-style-pill" data-style="acuarela digital, colores pastel, trazo artístico, ambiente cálido y acogedor" onclick="m6TogglePill(this)">🎨 Artístico</span>
          <span class="m6-style-pill" data-style="cyberpunk neon, fondo oscuro, líneas de neón, tecnología futurista" onclick="m6TogglePill(this)">⚡ Tecnológico</span>
        </div>
      </div>
      <div style="margin-bottom:18px;">
      ...
      <button onclick="m6GeneratePrompt()" class="gl-btn gl-btn-primary" style="background:#10b981;width:100%;">🚀 Generar Prompt Visual</button>
  ...
  <div class="section-card animate-in">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px;margin-top:20px;">
      ...
      <div style="border:1px solid rgba(37,99,235,0.3);border-radius:14px;padding:20px;background:rgba(37,99,235,0.04);">
        ...
        <a href="https://designer.microsoft.com" target="_blank" class="m6-tool-badge" style="display:flex;justify-content:center;">Abrir Designer →</a>
      </div>
      <div style="border:1px solid rgba(245,158,11,0.3);border-radius:14px;padding:20px;background:rgba(245,158,11,0.04);">
        ...
        <a href="https://firefly.adobe.com" target="_blank" class="m6-tool-badge" style="display:flex;justify-content:center;">Abrir Firefly →</a>
      </div>
      <div style="border:1px solid rgba(139,92,246,0.3);border-radius:14px;padding:20px;background:rgba(139,92,246,0.04);">
        ...
        <a href="https://leonardo.ai" target="_blank" class="m6-tool-badge" style="display:flex;justify-content:center;">Abrir Leonardo →</a>
      </div>
    </div>
    <div class="info-box tip" style="margin-top:24px;">
      <strong>¿Cuál usar?</strong> Para uso diario y redes: <b>Canva</b>. Para documentos oficiales: <b>MS Designer</b>. Para arte de calidad: <b>Leonardo.ai</b>.
    </div>
  </div>
</div>
...
<div id="m6-quiz" class="ag-content">
  <div class="section-card animate-in">
    ...
    <div id="m6-game" style="margin-top:20px;">
      <button class="gl-btn gl-btn-primary" style="width:100%" onclick="initM6Game()">🎮 Iniciar Juego</button>
    </div>
  </div>
</div>
...
<div id="m6-mission" class="ag-content">
  <div class="exercise-box mission-card animate-in">
    ...
    <div class="preparation-step" style="background: rgba(16,185,129,0.1); border: 1px solid #10b981; padding: 15px; border-radius: 10px; margin-top: 20px; border-left: 4px solid #10b981;">
      ...
      <p style="font-size: 0.8rem; margin-bottom: 0; opacity: 0.9;">Antes de iniciar, elige una herramienta de diseño (Canva, MS Designer o Adobe Firefly) y asegúrate de tener una cuenta activa.</p>
    </div>
    <div class="mission-instructions" style="background:rgba(16,185,129,0.05);padding:20px;border-radius:12px;border-left:4px solid #10b981;margin:20px 0;">
      ...
      <ol style="margin-top:12px;font-size:0.85rem;line-height:2;">
        <li><strong>Laboral:</strong> Crea un póster para un evento de tu área (jornada, reunión, campaña). Usa el Generador de Prompts del Lab y luego ve a Canva o MS Designer.</li>
        <li><strong>Personal:</strong> Genera una foto de perfil profesional o un banner para LinkedIn usando MS Designer o Adobe Firefly.</li>
      </ol>
    </div>
...
<div id="m7-lab" class="ag-content active">
  <div class="section-card animate-in">
    ...
    <div style="background:rgba(37,99,235,0.05);border:1px solid rgba(37,99,235,0.2);border-radius:14px;padding:22px;margin-top:20px;">
      ...
      <button onclick="m7GeneratePrompt()" class="gl-btn gl-btn-primary" style="width:100%;background:#2563eb;">🚀 Generar Prompt de Presentación</button>
    ...
    <div class="pista-ia" style="margin-top:20px;">
      💡 <strong>Flujo recomendado:</strong> 1) Genera el prompt aquí → 2) Pégalo en Gamma.app para auto-generar slides → 3) Ajusta imágenes y colores → ¡Listo en 5 min!
    </div>
  </div>
</div>
  ...
  <div class="section-card animate-in">
    ...
    <div style="margin-top:20px;">
      <div class="m7-tool-row" onclick="window.open('https://gamma.app','_blank')">
        ...
        <div style="flex:1;">
          <h4 style="margin:0 0 4px;">Gamma App</h4>
      ...
      <div class="m7-tool-row" onclick="window.open('https://beautiful.ai','_blank')">
        <span style="font-size:2.5rem;">💎</span>
        <div style="flex:1;">
          <h4 style="margin:0 0 4px;">Beautiful.ai</h4>
      ...
      <div class="m7-tool-row" onclick="window.open('https://www.decktopus.com','_blank')">
        <span style="font-size:2.5rem;">📊</span>
        <div style="flex:1;">
          <h4 style="margin:0 0 4px;">Decktopus AI</h4>
...
<div id="m7-game" class="ag-content">
  <div class="section-card animate-in">
    ...
    <div id="m7-game-container" style="margin-top:20px;">
      <button class="gl-btn gl-btn-primary" style="width:100%" onclick="initM7Game()">🎮 Iniciar Simulador</button>
    </div>
  </div>
</div>
...
<div id="m7-mission" class="ag-content">
  <div class="exercise-box mission-card animate-in">
    ...
    <div class="preparation-step" style="background: rgba(37,99,235,0.1); border: 1px solid #2563eb; padding: 15px; border-radius: 10px; margin-top: 20px; border-left: 4px solid #2563eb;">
      ...
      <p style="font-size: 0.8rem; margin-bottom: 0; opacity: 0.9;">Antes de iniciar, abre <b>Gamma.app</b> en tu navegador y ten listo el tema de tu área sobre el cual quieres generar la presentación.</p>
    </div>
    <div class="mission-instructions" style="background:rgba(37,99,235,0.05);padding:20px;border-radius:12px;border-left:4px solid #2563eb;margin:20px 0;">
      ...
      <ol style="margin-top:12px;font-size:0.85rem;line-height:2;">
        <li><strong>Laboral:</strong> Usa el Constructor de este módulo para generar el prompt, luego ve a <b>Gamma.app</b> y crea una presentación de tu área o proyecto. Descarga o comparte el enlace.</li>
        <li><strong>Personal:</strong> Crea con Gamma tu presentación personal para una entrevista o para presentación en LinkedIn (usa el prompt de "Uso Personal" de esta guía).</li>
      </ol>
    </div>
    <div class="input-glow-wrapper">
