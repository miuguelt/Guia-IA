  ...
  <div class="section-card glass-card animate-in">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px;margin-top:25px;">
      ...
      <div onclick="window.open('${t.url}','_blank')" class="glass-card" style="padding:22px;cursor:pointer;background:rgba(255,255,255,0.01);border-color:rgba(255,255,255,0.05);" onmouseover="this.style.borderColor='${t.color}88';this.style.background='${t.color}08'" onmouseout="this.style.borderColor='rgba(255,255,255,0.05)';this.style.background='rgba(255,255,255,0.01)'">
        ...
        <h4 style="margin:0 0 8px;color:${t.color};font-weight:800;"><a href="${t.url}" target="_blank" style="color:inherit; text-decoration:underline;">${t.name}</a></h4>
    ...
    <div class="learning-feedback-box" style="margin-top:25px; border-color:rgba(59,130,246,0.2); background:rgba(0,0,0,0.2); border-radius:12px; padding:20px; border:1px solid rgba(59,130,246,0.2);">
      <div style="font-weight:800; color:#60a5fa; font-size:0.85rem; margin-bottom:15px; display:flex; align-items:center; gap:8px;">📢 Antes vs Después: El Salto de Calidad</div>
      <div style="overflow-x:auto;">
        <table style="width:100%; font-size:0.75rem; border-collapse:collapse; color:#fff;">
          <tr style="border-bottom:1px solid #333; text-align:left;">
            <th style="padding:10px; color:#94a3b8;">Contexto</th>
            <th style="padding:10px; color:#94a3b8;">Prompt Pobre (Baja Calidad)</th>
            <th style="padding:10px; color:#60a5fa;">Prompt Soberano (Alta Calidad)</th>
          </tr>
          <tr style="border-bottom:1px solid #222;">
            <td style="padding:10px; font-weight:700;">Correo a Jefe</td>
            <td style="padding:10px; opacity:0.6;">"Escribe un correo sobre el retraso."</td>
            <td style="padding:10px; color:#60a5fa;">"Redacta un correo ejecutivo explicando el retraso en [X], proponiendo 2 soluciones y nueva fecha..."</td>
          </tr>
          <tr style="border-bottom:1px solid #222;">
            <td style="padding:10px; font-weight:700;">Resumen Acta</td>
            <td style="padding:10px; opacity:0.6;">"Resume esto."</td>
            <td style="padding:10px; color:#60a5fa;">"Extrae los 5 compromisos, responsables y fechas de este texto. Formato: Tabla Markdown."</td>
          </tr>
        </table>
      </div>
    </div>
...
<div id="m8-game" class="ag-content">
  <div class="section-card glass-card animate-in">
    ...
    <div id="m8-detective" class="thinking-process-premium" style="margin-top:25px;padding:30px;">
      <button class="gl-btn gl-btn-lux" style="width:100%;padding:20px;" onclick="window.initM8Detective()">⚡ INICIAR ESCÁNER DE TONO</button>
    </div>
  </div>
</div>
